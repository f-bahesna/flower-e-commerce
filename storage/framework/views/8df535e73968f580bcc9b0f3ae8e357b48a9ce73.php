      ...
      function readURL(input ,dom) {
        ...
        $(".gambar_lainnya").on("click",".btn-save-add", function(e){
            ...
            reader.onload = function (e) {
                    ...
                    type: "POST",
                    url: "<?php echo e(route('save.another.image')); ?>",
                    data: data,
                    cache: false,
                    contentType: false,
                    processData: false,
        ...
        $('.btn-delete-product').on("click",function(){
            ...
            $.ajax({
                ...
                type: "POST",
                url: "<?php echo e(route('delete.products')); ?>",
                data: {id : id},
                beforeSend: function() {    
                    btn.html(`<div class="d-flex justify-content-center">
                                                        <div class="spinner-border" role="status">
        ...
        $('.change-publish').on("click",function(){
            ...
            $.ajax({
                ...
                type: "POST",
                url: "<?php echo e(route('change.publish')); ?>",
        ...
        $(".btn-confirm-tolak").on("click",function(){
            ...
            $.ajax({
                ...
                type: "POST",
                url: "<?php echo e(route('tolak.order')); ?>",
        ...
        $(".btn-packing").on("click",function(){
            ...
            $.ajax({
                ...
                type: "POST",
                url: "<?php echo e(route('packing.order')); ?>",
        ...
        $(".btn-direct-manual").on("click",function(e){
            ...
            $.ajax({
                ...
                type: "POST",
                url: "<?php echo e(route('send.whatsapp.message')); ?>",
...
</script><?php /**PATH E:\Coding\PORTFOLIO\bunga\resources\views/utilities/scriptAdmin.blade.php ENDPATH**/ ?>