        ...
        <div class="col-lg-3" data-aos="fade-right">
          ...
          <div class="list-group my-4 categories-list">
            <?php $__currentLoopData = $jenis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <a href="<?php echo e(route('search-welcome-categories',['jenis' => $value->jenis_product])); ?>" class="list-group-item search-welcome-categories"><?php echo e(ucfirst($value->jenis_product)); ?></a>
          ...
          <div data-aos="fade-left" id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <img class="d-block img-fluid" src="<?php echo e(url('storage/carousel/guswin1.jpg')); ?>" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="<?php echo e(url('storage/carousel/guswin2.jpg')); ?>" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="<?php echo e(url('storage/carousel/guswin3.jpg')); ?>" alt="Third slide">
              </div>
            </div>
            ...
            <div class="card mt-4 ml-4 card-image card-intro-image" data-aos="fade-right">
                ...
                <div class="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4">
                    <div>
                        ...
                        <a href="<?php echo e(route('product.all')); ?>" class="btn btn-success btn-rounded"><i class="far fa-clone left"></i> Lihat Semua Product</a>
                    </div>
                </div>
            </div>
        </div>
         ...
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="row">
            <div class="col-md text-center">
              <a class="btn btn-lg btn-outline-default btn-rounded btn-lainnya waves-effect rounded" data-aos="fade-left" href="<?php echo e(route('product.all')); ?>">Lainnya</a>
            </div>
          </div>
      </div>
    </div>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="carousel-image">
              <img data-aos="fade-right" data-aos="fade-right" class="d-block rounded img-rounded" height="200" width="200"  src="<?php echo e(asset('storage/testimoni/testi1.jpg')); ?>" alt="First slide">
            </div>
          ...
          <div class="carousel-item">
            <img data-aos="fade-right" class="d-block rounded img-rounded" height="200" width="200" src="<?php echo e(asset('storage/testimoni/testi2.jpg')); ?>" alt="Second slide">
            <div class="carousel-caption d-none d-md-block text-dark">
          ...
          <div class="carousel-item">
            <img data-aos="fade-right" class="d-block rounded img-rounded" height="200" width="200" src="<?php echo e(asset('storage/testimoni/testi3.jpg')); ?>" alt="Third slide">
            <div class="carousel-caption d-none d-md-block text-dark">
...
<?php echo $__env->make('layouts.user.appUser', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Coding\PORTFOLIO\bunga\resources\views/welcome.blade.php ENDPATH**/ ?>