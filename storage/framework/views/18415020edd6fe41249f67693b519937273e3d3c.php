      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link navbar-text" href="<?php echo e(route('home-page')); ?>"><i class="fas fa-2x fa-arrow-left"></i>
...
<?php /**PATH E:\Coding\Portfolio\bunga\resources\views/layouts/user/appCart.blade.php ENDPATH**/ ?>